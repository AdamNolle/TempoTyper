...
SONG_LIST = [Song("Happy", 4, 25, "Example"), Song("TestSong", 8, 25, "Example"), Song("EasySong", DEFAULT_NOTE_SPEED, DEFAULT_NOTE_SPACING, "Easy"), Song("MediumSong", DEFAULT_NOTE_SPEED, DEFAULT_NOTE_SPACING, "Medium"), Song("HardSong", DEFAULT_NOTE_SPEED, DEFAULT_NOTE_SPACING, "Hard")]
